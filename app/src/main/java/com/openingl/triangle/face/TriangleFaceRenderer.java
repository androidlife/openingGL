package com.openingl.triangle.face;
...
public class TriangleFaceRenderer implements GLSurfaceView.Renderer {

    private Context context;
    //1byte = 8 bit
    //1float = 32 bit = 4 * 8 bit = 4 byte
    //clockwise = visually looks like frontface
...
//    };
    ...
    //anticlockwise = visually looks like backface
    float[] trianglePoints = {
            0f, 0f,
            1f, 0.5f,
            0f, 0.5f
    ...
    public TriangleFaceRenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String[] shaderCodes = TextReader.readShaderFromRawFile(context, R.raw.triangle);
