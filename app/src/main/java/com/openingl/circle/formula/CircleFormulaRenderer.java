package com.openingl.circle.formula;

import android.content.Context;
import android.opengl.GLSurfaceView;

import com.openinggl.R;
import com.openingl.gallery.main.GalleryUtils;
...
public class CircleFormulaRenderer implements GLSurfaceView.Renderer {
    ...
    public CircleFormulaRenderer(Context context) {
        this.context = context;
        //populatePoints();
        circlePoints = GalleryUtils.drawCircle(0, 0, 0.1f, 0f, 35);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String[] shaderCodes = TextReader.readShaderFromRawFile(context, R.raw.circle);
