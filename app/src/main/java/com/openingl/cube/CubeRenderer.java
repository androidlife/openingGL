...
public class CubeRenderer implements GLSurfaceView.Renderer {
    ...
    private void updateAngle() {
        incrementAngle();
        handler.postDelayed(angleUpdateRunnable, 100);
    }
    ...
    private Runnable angleUpdateRunnable = new Runnable() {
        @Override
        public void run() {
            updateAngle();
        }
    ...
    public void clearRunnable() {
        handler.removeCallbacks(angleUpdateRunnable);
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String[] shaderCodes = TextReader.readShaderFromRawFile(context, R.raw.cube);
    ...
    private void getIdsOfVariables(int programId) {
        ...
        colorVarId = glGetAttribLocation(programId, "a_color");
        printVarIdLocation("a_color", colorVarId);
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        //Matrix.multiplyMM(cubeTransform, 0, aspectMatrix, 0, cubeTransform, 0);
    }
