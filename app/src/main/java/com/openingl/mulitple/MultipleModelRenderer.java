...
public class MultipleModelRenderer implements GLSurfaceView.Renderer {
    ...
    int uColorId, aPositionId, uMatrixId;
    float[] aspectMatrix;
    ...
    public MultipleModelRenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String[] shaderCodes = TextReader.readShaderFromRawFile(context, R.raw.multiple_model);
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        glEnableVertexAttribArray(aPositionId);
        glUniform4f(uColorId, 0f, 1f, 0f, 1f);
        ...
        glEnableVertexAttribArray(aPositionId);
        glUniform4f(uColorId, 0f, 0f, 1f, 1f);
        ...
        glEnableVertexAttribArray(aPositionId);
        glUniform4f(uColorId, 1f, 0f, 1f, 1f);
