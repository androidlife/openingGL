package com.openingl.texture.repeatmode;
...
public class RepeatTextureRenderer implements GLSurfaceView.Renderer {
    private Context context;
    //inverted side
    // in order to show the repeat mode, just increase the value of U,V greater than 1
    // why greater than 1 we are say size is 40x40, if we do 2 , then it would be 80x80
    // our image is 40x40 and we do 80x80, then certain scaling mechanism is to be implemented
    // that is the repeat mode
    ...
    public RepeatTextureRenderer(Context context) {
