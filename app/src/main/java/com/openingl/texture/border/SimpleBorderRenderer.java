package com.openingl.texture.border;
...
public class SimpleBorderRenderer implements GLSurfaceView.Renderer {
...
//    };
    ...
    public SimpleBorderRenderer(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String[] shaderCodes = TextReader.readShaderFromRawFile(context, R.raw.simple_border_texture);
    ...
    private int generateTexture() {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.lena,
                options);
        if (bitmap == null) {
