...
public class CubeMoreActivity extends GvrActivity implements GvrView.StereoRenderer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Matrix.scaleM(modelCube, 0, 10, 10, 10);
        Matrix.translateM(modelCube, 0, 0.0f, 0.0f, -400f);
